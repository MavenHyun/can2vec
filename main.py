...
maven.mirror_image('mRNA1', mRNA1_T, maven.P['mRNA1'], 'adam', 1001, 1e-3)
mRNA1 = enc4
...
maven.mirror_image('mRNA2', mRNA2_T, maven.P['mRNA2'], 'adam', 1001, 1e-3)
mRNA2 = enc4
...
maven.mirror_image('mRNA3', mRNA3_T, maven.P['mRNA3'], 'adam', 1001, 1e-3)
mRNA3 = enc4
...
maven.mirror_image('mRNA4', mRNA4_T, maven.P['mRNA4'], 'adam', 1001, 1e-3)
mRNA4 = enc4

enc = maven.top_encoder('mut', 100, 'relu')
mut_T = maven.bot_decoder(enc, 'mut', 100, 'relu')
maven.mirror_image('mut', mut_T, maven.P['mut'], 'adam', 1001, 1e-3)
mut = enc
