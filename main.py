...
sae_CNV_dec1 = sae_CNV.construct_Decoder("CNV_Decoding_Layer1", sae_CNV_dec2.result, 550, sae_CNV.F_num, 0)
...
sae_mRNA_enc1 = sae_mRNA.construct_Encoder("mRNA_Encoding_Layer1", sae_mRNA.input_data, sae_mRNA.F_num, 4000, 0)
sae_mRNA_enc2 = sae_mRNA.construct_Encoder("mRNA_Encoding_Layer2", sae_mRNA_enc1.result, 4000, 2000, 0)
sae_mRNA_enc3 = sae_mRNA.construct_Encoder("mRNA_Encoding_Layer3", sae_mRNA_enc2.result, 2000, 2000, 0)
sae_mRNA_dec3 = sae_mRNA.construct_Decoder("mRNA_Decoding_Layer3", sae_mRNA_enc3.result, 2000, 2000, 0)
sae_mRNA_dec2 = sae_mRNA.construct_Decoder("mRNA_Decoding_Layer2", sae_mRNA_dec3.result, 2000, 4000, 0)
sae_mRNA_dec1 = sae_mRNA.construct_Decoder("mRNA_Decoding_Layer1", sae_mRNA_dec2.result, 4000, sae_mRNA.F_num, 0)
