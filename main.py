...
maven.mirror_image('mRNA1', mRNA1_T, maven.P['mRNA1'], 'adam', 50001, 1e-3)
...
maven.mirror_image('mRNA2', mRNA2_T, maven.P['mRNA2'], 'adam', 50001, 1e-3)
...
maven.mirror_image('mRNA3', mRNA3_T, maven.P['mRNA3'], 'adam', 50001, 1e-3)
...
maven.mirror_image('mRNA4', mRNA4_T, maven.P['mRNA4'], 'adam', 50001, 1e-3)
