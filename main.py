...
enc2 = maven.mid_encoder('mRNA1', 2000, 800, 'relu', enc1)
enc3 = maven.mid_encoder('mRNA1', 800, 100, 'relu', enc2)
dec3 = maven.mid_decoder('mRNA1', 100, 800, 'relu', enc3)
dec2 = maven.mid_decoder('mRNA1', 800, 2000, 'relu', dec3)
dec1 = maven.mid_decoder('mRNA1', 2000, 4000, 'relu', dec2)
mRNA1_T = maven.bot_decoder(dec1, 'mRNA1', 4000, 'relu')
maven.mirror_image('mRNA1', mRNA1_T, maven.P['mRNA1'], 'adam', 5001, 1e-3)
...
enc2 = maven.mid_encoder('mRNA2', 2000, 800, 'relu', enc1)
enc3 = maven.mid_encoder('mRNA2', 800, 100, 'relu', enc2)
dec3 = maven.mid_decoder('mRNA2', 100, 800, 'relu', enc3)
dec2 = maven.mid_decoder('mRNA2', 800, 2000, 'relu', dec3)
dec1 = maven.mid_decoder('mRNA2', 2000, 4000, 'relu', dec2)
mRNA2_T = maven.bot_decoder(dec1, 'mRNA2', 4000, 'relu')
maven.mirror_image('mRNA2', mRNA2_T, maven.P['mRNA2'], 'adam', 5001, 1e-3)
...
enc2 = maven.mid_encoder('mRNA3', 2000, 800, 'relu', enc1)
enc3 = maven.mid_encoder('mRNA3', 800, 100, 'relu', enc2)
dec3 = maven.mid_decoder('mRNA3', 100, 800, 'relu', enc3)
dec2 = maven.mid_decoder('mRNA3', 800, 2000, 'relu', dec3)
dec1 = maven.mid_decoder('mRNA3', 2000, 4000, 'relu', dec2)
mRNA3_T = maven.bot_decoder(dec1, 'mRNA3', 4000, 'relu')
maven.mirror_image('mRNA3', mRNA3_T, maven.P['mRNA3'], 'adam', 5001, 1e-3)
...
enc2 = maven.mid_encoder('mRNA4', 2000, 800, 'relu', enc2)
enc3 = maven.mid_encoder('mRNA4', 800, 100, 'relu', enc3)
dec3 = maven.mid_decoder('mRNA4', 100, 800, 'relu', enc3)
dec2 = maven.mid_decoder('mRNA4', 800, 2000, 'relu', dec3)
dec1 = maven.mid_decoder('mRNA4', 2000, 4000, 'relu', dec2)
mRNA4_T = maven.bot_decoder(dec1, 'mRNA4', 4000, 'relu')
maven.mirror_image('mRNA4', mRNA4_T, maven.P['mRNA4'], 'adam', 5001, 1e-3)
