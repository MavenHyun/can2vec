...
enc2 = maven.mid_encoder('mRNA1', 800, 800, 'relu', enc1)
enc3 = maven.mid_encoder('mRNA1', 800, 100, 'relu', enc1)
dec3 = maven.mid_decoder('mRNA1', 100, 800, 'relu', enc3)
dec2 = maven.mid_decoder('mRNA1', 800, 800, 'relu', dec3)
...
enc2 = maven.mid_encoder('mRNA2', 800, 800, 'relu', enc1)
enc3 = maven.mid_encoder('mRNA2', 800, 100, 'relu', enc1)
dec3 = maven.mid_decoder('mRNA2', 100, 800, 'relu', enc3)
dec2 = maven.mid_decoder('mRNA2', 800, 800, 'relu', dec3)
...
enc2 = maven.mid_encoder('mRNA3', 800, 800, 'relu', enc1)
enc3 = maven.mid_encoder('mRNA3', 800, 100, 'relu', enc1)
dec3 = maven.mid_decoder('mRNA3', 100, 800, 'relu', enc3)
dec2 = maven.mid_decoder('mRNA3', 800, 800, 'relu', dec3)
...
enc2 = maven.mid_encoder('mRNA4', 800, 800, 'relu', enc1)
enc3 = maven.mid_encoder('mRNA4', 800, 100, 'relu', enc1)
dec3 = maven.mid_decoder('mRNA4', 100, 800, 'relu', enc3)
dec2 = maven.mid_decoder('mRNA4', 800, 800, 'relu', dec3)
