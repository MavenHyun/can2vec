...
enc2 = maven.mid_encoder('CNV', 500, 100, 'relu', enc1)
dec2 = maven.mid_encoder('CNV', 100, 500, 'relu', enc2)
...
dec4 = maven.mid_encoder('mRNA', 100, 500, 'relu', enc4)
dec3 = maven.mid_encoder('mRNA', 500, 1000, 'relu', dec4)
dec2 = maven.mid_encoder('mRNA', 1000, 5000, 'relu', dec3)
