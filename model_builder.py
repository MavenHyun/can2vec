...
def create_model(pretrain):
    ...
    with tf.name_scope("mRNA_AEncoder"):
        enc = maven.top_encoder('mRNA', 16000, 'relu')
        enc1 = maven.mid_encoder('mRNA', 9000, 'relu', enc)
        dec1 = maven.mid_decoder('mRNA', 16000, 'relu', enc1)
