...
class stacked_ae:
    ...
    def data_training(self, file_name, file_name2):
        ...
        weights = {
            ...
            'W_dec1': tf.Variable(tf.random_normal([self.num_hnodes1, self.X.shape[1] + self.Y.shape[1]]))
        }
        bias = {
            ...
            'B_dec1': tf.Variable(tf.random_normal([self.X.shape[1] + self.Y.shape[1]]))
        }
...
class practice_autoencoder:
    ...
    def __init__(self, h1, h2, h3, h4, h5, h6, lr1, lr2, lr3, dn):
    ...
    def data_training(self, file_name, file_name2):
        ...
        weights = {
            'W_mut_enc': tf.Variable(tf.random_normal([self.X_mut.shape[1], self.num_hnodes_mut1])),
...
test = stacked_ae(300, 100, 0.8, True)
